...
void setup_bb(void) {
    ...
    GPIOB->MODER |= GPIO_MODER_MODER15_0| GPIO_MODER_MODER13_0| GPIO_MODER_MODER12_0;
    GPIOB->BSRR = GPIO_BSRR_BR_13 | GPIO_BSRR_BS_12;
}
...
void init_spi1() {
    ...
    GPIOA->AFR[0] &= 0x0f0ffff;
    GPIOA->AFR[1] &= 0x0ffffff;
...
void spi1_display1(const char *string) {
    spi_cmd(0x02);
    char* i;
    for(i=string;*i != '\0'; i =i +sizeof(char)){
        spi_data(*i);
    }
}
